...
vibrate=$(timelimit -q -t3 idevicesyslog | grep -o "ActiveCategory_IncrementBy, value = 0.062\|Volume Upper: up\|VolumeControl -- volume increment down:1\|Volume Up: VolumeControl -- volume increment -- button state: up" | wc -l)
